...
import { Outfit, Workout, UserProfile, Season, Recipe } from '../types';
import { t } from '../i18n';
...
const StyleWorkout: React.FC<Props> = ({ outfit, workout, recipe, quote, user, onSeasonChange, onOpenProfile, onRefresh, isLoading }) => {
    ...
    // ... (Keep existing Emoji logic functions getItemEmoji and getWorkoutEmoji) ...
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark min-h-screen pb-32 font-display">
            ...
            {/* Custom Header with Integrated Season Filter */}
            <header className="sticky top-0 z-50 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-md border-b border-peach-accent/30 dark:border-white/5">
                <div className="max-w-7xl mx-auto w-full px-6 pt-12 pb-4">
                    ...
                    {/* Season Filter: Moved INSIDE Header */}
            ...
            <main className="px-4 pt-6 space-y-8 animate-fade-in max-w-7xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    {/* Right Column: Details & Workout */}
                    <section className="space-y-6">
                        {/* Component Pieces */}
                        {outfit.items && outfit.items.length > 0 && (
                            <div className="space-y-3">
                                <h4 className="text-sm font-bold text-gray-900 dark:text-white px-1">Component Pieces</h4>
                                <div className="flex gap-3 overflow-x-auto no-scrollbar pb-4 -mx-4 px-4 snap-x md:mx-0 md:px-0">
                        ...
                        {/* Why This Outfit */}
                        <div className="bg-gradient-to-br from-peach-light to-white dark:from-peach-dark/20 dark:to-white/5 p-5 rounded-2xl border border-peach-accent/40 shadow-sm relative overflow-hidden">
                        ...
                        {/* Workout Routine */}
                        <div className="space-y-4 pt-4 border-t border-peach-accent/20 dark:border-white/5">
