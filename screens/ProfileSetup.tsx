...
const ProfileSetup: React.FC<Props> = ({ user, onUpdate, onClose, userRole = 'guest' }) => {
            ...
            <main className="flex-1 px-6 space-y-10 pt-4">
                        ...
                        {Object.values(Gender).map((g) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex-1 py-3 rounded-xl text-sm font-bold transition-all ${isSelected
                ...
                <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        ...
                        <div
                            ...
                            className={`cursor-pointer group p-2 py-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-3 ${user.boneStructure === BoneStructure.Ectomorph
                        ...
                        <div
                            ...
                            className={`cursor-pointer group p-2 py-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-3 ${user.boneStructure === BoneStructure.Normal
                                    ? 'bg-peach-light dark:bg-primary/10 border-primary'
                                    : 'bg-white dark:bg-white/5 border-transparent hover:border-primary/20'
                                }`}
                        >
                        ...
                        <div
                            ...
                            className={`cursor-pointer group p-2 py-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-3 ${user.boneStructure === BoneStructure.Mesomorph
                                    ? 'bg-peach-light dark:bg-primary/10 border-primary'
                                    : 'bg-white dark:bg-white/5 border-transparent hover:border-primary/20'
                                }`}
                        >
                        ...
                        <div
                            ...
                            className={`cursor-pointer group p-2 py-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-3 ${user.boneStructure === BoneStructure.Endomorph
                                    ? 'bg-peach-light dark:bg-primary/10 border-primary'
                                    : 'bg-white dark:bg-white/5 border-transparent hover:border-primary/20'
                                }`}
                        >
                        ...
                        {[
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative rounded-3xl overflow-hidden group border-4 transition-all aspect-[3/2] ${isSelected ? 'border-primary shadow-lg scale-[1.02]' : 'border-transparent shadow-sm'
                                        }`}
                                >
                                    {isGenerating ? (
                        ...
                        {tastes.map((taste) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`p-3 rounded-2xl border-2 transition-all flex flex-col items-center justify-center gap-1 ${isActive
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        {allMbtis.map(m => (
                            <button
                                ...
                                className={`h-14 rounded-xl text-xs font-bold transition-all border-2 flex items-center justify-center ${user.mbti === m
                ...
                <section className="pt-6 border-t border-gray-100 dark:border-white/5 space-y-4">
                    ...
                    <div className="flex flex-col gap-3 p-3 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5">
                        ...
                        {/* Provider Switcher (admin 전용 - guest에게는 숨김) */}
                        {user.useAI && userRole === 'admin' && (
                            <div className="flex bg-white dark:bg-black/20 p-1 rounded-lg border border-gray-200 dark:border-white/5">
                                <button
                                    ...
                                    className={`flex-1 py-2 rounded-md text-[10px] font-bold transition-all flex items-center justify-center gap-1 ${user.aiProvider === AIProvider.Gemini ? 'bg-indigo-500 text-white shadow-sm' : 'text-gray-400'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-2 rounded-md text-[10px] font-bold transition-all flex items-center justify-center gap-1 ${user.aiProvider === AIProvider.OpenAI ? 'bg-green-600 text-white shadow-sm' : 'text-gray-400'
                                        }`}
                                >
